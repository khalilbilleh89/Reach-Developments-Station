...
class PaymentPlanService:
    ...
    def generate_schedule_for_contract(
        ...
        return self._build_list_response(contract.id, persisted, contract.currency or DEFAULT_CURRENCY)
    ...
    def get_schedule_for_contract(
        ...
        return self._build_list_response(contract_id, rows, contract.currency or DEFAULT_CURRENCY)
    ...
    def regenerate_schedule_for_contract(
        ...
        return self._build_list_response(contract_id, persisted, contract.currency or DEFAULT_CURRENCY)
    ...
    def _build_schedule_rows(
        ...
        contract_currency = contract.currency or DEFAULT_CURRENCY
        return [
            {
                "contract_id": contract.id,
                "template_id": template.id,
    ...
    def create_payment_plan(self, data: PaymentPlanCreate) -> PaymentPlanResponse:
        ...
        return self._build_plan_response(template.name, template.plan_type, persisted, contract.currency or DEFAULT_CURRENCY)
    ...
    def get_contract_payment_plan(self, contract_id: str) -> PaymentPlanResponse:
        ...
        return self._build_plan_response(plan_name, plan_type, rows, contract.currency or DEFAULT_CURRENCY)
