...
from app.modules.feasibility_feedback.api import router as feasibility_feedback_router
from app.modules.project_structure.api import router as project_structure_router
from app.modules.construction_costs.api import router as construction_costs_router
from app.modules.tender_comparison.api import router as tender_comparison_router
from app.modules.pricing_optimization.api import (
    projects_router as pricing_optimization_projects_router,
    portfolio_router as pricing_optimization_portfolio_router,
)
from app.modules.phasing_optimization.api import (
...
from app.modules.strategy_generator.api import (
    projects_router as strategy_generator_projects_router,
    portfolio_router as strategy_generator_portfolio_router,
)
from app.modules.portfolio_auto_strategy.api import router as portfolio_auto_strategy_router
from app.modules.strategy_execution_package.api import (
    projects_router as strategy_execution_package_projects_router,
    portfolio_router as strategy_execution_package_portfolio_router,
)
from app.modules.strategy_approval.api import (
...
from app.modules.strategy_learning.api import (
...
app.include_router(feasibility_feedback_router, prefix=_API_PREFIX)
app.include_router(project_structure_router, prefix=_API_PREFIX)
app.include_router(construction_costs_router, prefix=_API_PREFIX)
app.include_router(tender_comparison_router, prefix=_API_PREFIX)
app.include_router(pricing_optimization_projects_router, prefix=_API_PREFIX)
...
app.include_router(strategy_generator_projects_router, prefix=_API_PREFIX)
app.include_router(strategy_generator_portfolio_router, prefix=_API_PREFIX)
app.include_router(portfolio_auto_strategy_router, prefix=_API_PREFIX)
app.include_router(strategy_execution_package_projects_router, prefix=_API_PREFIX)
