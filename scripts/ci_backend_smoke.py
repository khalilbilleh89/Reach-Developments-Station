...
MIGRATIONS: dict[str, tuple[str, tuple[str, ...]]] = {
    "0034_unit_current_costs.py": (
        "unit_economics",
        (
            "tests/modules/test_unit_economics_current_costs.py::test_current_settings_migration_roundtrip",
        ),
    ),
    "0033_contract_payments.py": (
        "construction",
        ("tests/modules/test_construction_contract_first.py::test_payment_migration_roundtrip",),
    ),
    "0031_technical_specs.py": (
        "construction",
        ("tests/modules/test_technical_specifications.py::test_specification_migration_roundtrip",),
    ),
    "0030_unit_removal.py": (
        "inventory",
        (
            "tests/modules/test_inventory_owner_removal.py::test_removal_migration_and_history_guard",
        ),
    ),
    "0026_installment_tax.py": (
        "payment_plans",
        ("tests/modules/test_payment_plan_tax.py::test_tax_migration_roundtrip",),
    ),
    "0029_merge_installment_tax.py": (
        "payment_plans",
        ("tests/test_migrations.py::test_sales_and_common_area_histories_converge",),
    ),
    "0028_merge_permit_sales.py": (
        "projects",
        ("tests/test_migrations.py::test_sales_and_common_area_histories_converge",),
    ),
