...
const event = { name: 'pull_request', base: 'main', head: 'eng/property-presentation', repository: 'khalilbilleh89/Reach-Developments-Station', headRepository: 'khalilbilleh89/Reach-Developments-Station' };
