...
const event = { name: 'pull_request', base: 'main', head: 'eng/development-briefing', repository: 'khalilbilleh89/Reach-Developments-Station', headRepository: 'khalilbilleh89/Reach-Developments-Station' };
