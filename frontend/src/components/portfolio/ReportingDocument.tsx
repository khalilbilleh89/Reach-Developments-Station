...
function DevelopmentFacts({ snapshot }: { snapshot: Snapshot }) {
  return <section className="reporting-section">
    <SectionHeader level={2} title="Captured permit and design records" />
