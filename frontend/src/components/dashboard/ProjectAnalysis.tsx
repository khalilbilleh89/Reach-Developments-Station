...
function Counts({ values, label }: { values: Record<string, number>; label: string }) {
  return <section className="analysis-counts"><h4>{label}</h4>
    <dl>{Object.entries(values).map(([name, count]) => <div key={name}>
