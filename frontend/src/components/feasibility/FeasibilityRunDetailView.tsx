...
function FeasibilityAssumptionsForm({
  ...
  // Dirty tracking: true whenever any field changes since the last save.
  // Reported to parent so the Calculate button can be disabled until saved.
        ...
        >
          <div>
            ...
            <input
              ...
              step="any"
              value={sellableArea}
              onChange={(e) => { setSellableArea(e.target.value); markDirty(); }}
              style={fieldStyle}
          ...
          <div>
            ...
            <input
              ...
              step="any"
              value={avgSalePrice}
              onChange={(e) => { setAvgSalePrice(e.target.value); markDirty(); }}
              style={fieldStyle}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => { setConstructionCost(e.target.value); markDirty(); }}
              style={fieldStyle}
              placeholder="e.g. 800"
            />
          </div>
          <div>
            ...
            <input
              ...
              step="any"
              value={softCostRatio}
              onChange={(e) => { setSoftCostRatio(e.target.value); markDirty(); }}
              style={fieldStyle}
              placeholder="e.g. 10"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) => { setFinanceCostRatio(e.target.value); markDirty(); }}
              style={fieldStyle}
              placeholder="e.g. 5"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) => { setSalesCostRatio(e.target.value); markDirty(); }}
              style={fieldStyle}
              placeholder="e.g. 3"
            />
          </div>
          <div>
            ...
            <input
              ...
              step="1"
              value={devPeriod}
              onChange={(e) => { setDevPeriod(e.target.value); markDirty(); }}
              style={fieldStyle}
              placeholder="e.g. 24"
            />
          </div>
        ...
        <>
          ...
          >
            <button
              ...
              disabled={calculating || !assumptions || formDirty}
              style={{
                padding: "10px 28px",
                border: "none",
                borderRadius: 6,
                background:
                  calculating || !assumptions || formDirty
                    ? "#94a3b8"
                    : "var(--color-primary, #2563eb)",
                color: "#fff",
                cursor: calculating || !assumptions || formDirty ? "not-allowed" : "pointer",
                fontSize: "0.875rem",
                fontWeight: 600,
              }}
            >
            ...
            {assumptions && formDirty && (
              <span
                style={{ fontSize: "0.8rem", color: "#854d0e" }}
              >
                Unsaved changes — save assumptions before calculating.
              </span>
            )}
            {calcError && (
              <span
