...
function PortfolioScreen() {
  ...
  const section = requested === "risks" ? "exceptions" : ["projects", "outlook", "exceptions", "actions"].includes(requested ?? "") ? requested! : "overview";
