...
export type CommissionStatus = "Approved" | "Pending" | "Paid" | "Under Review";

export interface DemoCommissionRow {
  ref: string;
  agentName: string;
  agencyName: string;
  unitRef: string;
...
export const demoCommissionRows: DemoCommissionRow[] = [
  {
    ref: "COM-2026-001",
    agentName: "Rania Khalil",
    agencyName: "Apex Realty",
    unitRef: "ARR-B2-1204",
    projectName: "Al Reem Residences",
    contractValue: "AED 4,200,000",
    commissionRate: "2.5%",
    commissionDue: "AED 105,000",
    status: "Approved",
    dueDate: "31 Mar 2026",
  },
  {
    ref: "COM-2026-002",
    agentName: "Tariq Siddiqui",
    agencyName: "Landmark Properties",
    unitRef: "MBT-T1-0508",
    projectName: "Marina Bay Towers",
    contractValue: "AED 6,850,000",
    commissionRate: "2.0%",
    commissionDue: "AED 137,000",
    status: "Paid",
    dueDate: "15 Feb 2026",
  },
  {
    ref: "COM-2026-003",
    agentName: "Layla Al Farsi",
    agencyName: "Prestige Living",
    unitRef: "SGR-A1-0301",
    projectName: "Saadiyat Grove",
    contractValue: "AED 8,100,000",
    commissionRate: "2.5%",
    commissionDue: "AED 202,500",
    status: "Pending",
    dueDate: "30 Apr 2026",
  },
  {
    ref: "COM-2026-004",
    agentName: "Hassan Al Nuaimi",
    agencyName: "Gulf Estates",
    unitRef: "ARR-B3-0712",
    projectName: "Al Reem Residences",
    contractValue: "AED 3,750,000",
    commissionRate: "2.5%",
    commissionDue: "AED 93,750",
    status: "Under Review",
    dueDate: "15 Apr 2026",
  },
  {
    ref: "COM-2026-005",
    agentName: "Mira Al Tamimi",
    agencyName: "Apex Realty",
    unitRef: "MBT-T2-1105",
    projectName: "Marina Bay Towers",
    contractValue: "AED 5,400,000",
    commissionRate: "2.0%",
    commissionDue: "AED 108,000",
    status: "Paid",
    dueDate: "10 Jan 2026",
  },
  {
    ref: "COM-2026-006",
    agentName: "Yousef Al Blooshi",
    agencyName: "Prime Select",
    unitRef: "SGR-B2-0210",
    projectName: "Saadiyat Grove",
    contractValue: "AED 9,200,000",
    commissionRate: "2.5%",
    commissionDue: "AED 230,000",
    status: "Pending",
    dueDate: "15 May 2026",
  },
];
